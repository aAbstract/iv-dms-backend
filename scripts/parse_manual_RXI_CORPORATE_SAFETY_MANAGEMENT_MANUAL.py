...
def create_parts_metadata_file():
    metadata = []
    manual_parts = glob(r"data/RXI_CORPORATE_SAFETY_MANAGEMENT_MANUAL/*.pdf")
    ...
    with open("data/RXI_CORPORATE_SAFETY_MANAGEMENT_MANUAL/RXI_CORPORATE_SAFETY_MANAGEMENT_MANUAL_metadata.json", "w") as f:
...
def create_manual_toc_tree():
    ...
    f = open("data/RXI_CORPORATE_SAFETY_MANAGEMENT_MANUAL/RXI_CORPORATE_SAFETY_MANAGEMENT_MANUAL_metadata.json", "r")
    json_str = f.read()
    f.close()
    ...
    for mde in json_obj:
        toc_txt = ""
        pdf_reader = PdfReader("data/RXI Corporate Safety Management Manual Ver.0 - 18 DEC 23.pdf")
    ...
    f = open("data/RXI_CORPORATE_SAFETY_MANAGEMENT_MANUAL/RXI_CORPORATE_SAFETY_MANAGEMENT_MANUAL_second_metadata.json", "w")
...
def rearrange_manual_content_tree() -> list[object]:
    ...
    path_to_metadata = "data/RXI_CORPORATE_SAFETY_MANAGEMENT_MANUAL/RXI_CORPORATE_SAFETY_MANAGEMENT_MANUAL_second_metadata.json"
    all_chapters = []
    all_sub1_sections = []
    all_sub2_section = []
    all_sub3_section = []
    ...
    with open("data/RXI_CORPORATE_SAFETY_MANAGEMENT_MANUAL/RXI_CORPORATE_SAFETY_MANAGEMENT_MANUAL_second_metadata_tree.json", "w") as json_file:
...
print("Complete Parse of RXI_CORPORATE_SAFETY_MANAGEMENT_MANUAL")